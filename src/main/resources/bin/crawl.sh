...
java --add-opens java.base/java.lang.invoke=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/java.util=ALL-UNNAMED -jar content-crawler.jar $COMMAND --config $P.yml
rm -f $P.yml
